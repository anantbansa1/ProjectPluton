      ...
      <div className=" mt-[3vw] max-md:ml-[15vw] ml-[20vw] text-white">
        ...
        <div className="flex max-md:flex-col max-md:space-y-5  max-md:mx-0 max-xl:text-base items-end  mt-5 mb-10 w-[80vw] md:w-[78vw] space-x-2   ">
          <div className="w-[33%] max-md:w-[100%]  h-[250px] grid grid-rows-[repeat(5,minmax(40px,auto))] grid-cols-[2fr_1fr_2fr]">
            <div className="flex flex-col shadow-[#39495f] bg-[#130f22]  h-[230px] shadow-md rounded-lg row-start-2 col-start-1 row-span-4 col-span-3"></div>
            <img
              src={rank2}
          ...
          <div className="w-[33%] max-md:w-[100%]  h-[300px] grid grid-rows-[repeat(5,minmax(40px,auto))] grid-cols-[2fr_1fr_2fr]">
            <div className="flex flex-col shadow-[#39495f] bg-[#130f22]  h-[280px] shadow-md rounded-lg row-start-2 col-start-1 row-span-4 col-span-3"></div>
            <img
              src={rank1}
              className="row-start-1 row-span-2 mx-auto  col-start-1 col-span-3 h-[80px]"
            ></img>
