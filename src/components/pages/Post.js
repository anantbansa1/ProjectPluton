    ...
    <div>
      ...
      <div className="flex-col max-[710px]:mx-auto  max-[619px]:mx-auto max-[820px]:space-x-100 mt-2">
        ...
        <div className="ml-[20vw] max-md:ml-[15vw] my-10">
          <div className=" mx-auto flex flex-col justify-center items-center w-[65vw] max-md:w-[75vw] h-fit bg-[#130f22] shadow-xl rounded-2xl max-md:py-4 py-8 px-4 shadow-black text-white">
